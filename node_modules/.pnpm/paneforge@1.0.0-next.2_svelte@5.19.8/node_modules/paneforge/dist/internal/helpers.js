...
export function updateResizeHandleAriaValues({ groupId, layout, paneDataArray, }) {
...
export function paneDataHelper(paneDataArray, paneData, layout) {
...
export function findPaneDataIndex(paneDataArray, paneData) {
    return paneDataArray.findIndex((prevPaneData) => prevPaneData.id === paneData.id);
}
// Layout should be pre-converted into percentages
export function callPaneCallbacks(paneArray, layout, paneIdToLastNotifiedSizeMap) {
...
export function getUnsafeDefaultLayout({ paneDataArray }) {
