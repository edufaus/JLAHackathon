...
export type PaneProps = PanePropsWithoutHTML & Without<PaneForgePrimitiveDivAttributes, PanePropsWithoutHTML>;
...
export type PaneGroupProps = PaneGroupPropsWithoutHTML & Without<PaneForgePrimitiveDivAttributes, PaneGroupPropsWithoutHTML>;
...
export type PaneResizerProps = PaneResizerPropsWithoutHTML & Without<PaneForgePrimitiveDivAttributes, PaneResizerPropsWithoutHTML>;
export type PaneAPI = {
    collapse: () => void;
    expand: () => void;
    getId: () => string;
