import { addEventListener, executeCallbacks, useRefById, } from "svelte-toolbelt";
...
class PaneGroupState {
    ...
    layout = $state.raw([]);
    paneDataArray = $state.raw([]);
    paneDataArrayChanged = $state(false);
...
class PaneResizerState {
    ...
    #onkeydown = (e) => {
        if (this.#disabled.current || !this.resizeHandler || e.defaultPrevented)
            return;
