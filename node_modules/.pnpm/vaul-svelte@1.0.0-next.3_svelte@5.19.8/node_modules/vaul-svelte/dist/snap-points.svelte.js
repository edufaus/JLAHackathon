...
export class SnapPointsState {
    ...
    windowDimensions = $state.raw(isBrowser
        ? {
    ...
    onRelease = (props) => {
        if (this.fadeFromIndex === undefined)
            return;
        const currentPosition = this.#direction === "bottom" || this.#direction === "right"
        ...
        if (!this.#snapToSequentialPoint && props.velocity > 2 && !hasDraggedUp) {
            if (props.dismissible)
                ...
                this.snapToPoint(this.snapPointsOffset[0]);
            return;
        }
    ...
    onDrag = (props) => {
        if (this.activeSnapPointOffset === null)
            return;
        const newValue = this.#direction === "bottom" || this.#direction === "right"
    ...
    getPercentageDragged = (absDraggedDistance, isDraggingDown) => {
        ...
        if (isOverlaySnapPoint && !isDraggingDown)
            return 1;
        if (!this.shouldFade && !isOverlaySnapPoint)
            return null;
